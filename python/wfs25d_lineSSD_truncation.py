...
N = int(4/dx0)+1
L = N*dx0  # this is the length of wfs25d_lineSSD_aliasing.py
print('L', L, 'k L', k*L)

dx0 = lmb/32  # now use this dx0 to simulate quasi-cont array,
# i.e. savely avoid aliasing
print('dx0', dx0)
N = int(L/dx0)+1  # and find N that closely matches L, make sure its odd
...
plt.savefig('wfs25d_lineSSD_truncation.png')
...
sfs.plot2d.loudspeakers(array.x, array.n, selection * array.a, size=0.05)
plt.savefig('wfs25d_lineSSD_truncation_sfstoolbox.png')
...
plt.savefig('wfs25d_lineSSD_truncation_FRP.png')
np.savez('wfs25d_lineSSD_truncation_FRP_data', phi=phi, p=p)
